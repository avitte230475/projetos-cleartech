...
namespace EstoqueDeProdutos
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            builder.Services.AddScoped<IControleEstoqueRepository, ControleEstoqueRepository>();
            builder.Services.AddScoped<ProdutoService, ProdutoService>();
            builder.Services.AddScoped<ProdutoService, ProdutoService>();
            builder.Services.AddScoped<ControleEstoqueService, ControleEstoqueService>();
